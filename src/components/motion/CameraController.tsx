...
import { TrackballControls as TrackType } from "three-stdlib";
      ...
      switch (cameraState) {
          ...
          if (selectedPlanet) {
            ...
            if (currentPlanetPosition) {
              ...
              controls.minDistance =
                selectedPlanet.radius * detailViewMinDistance;
              controls.maxDistance =
                selectedPlanet.radius * detailViewMaxDistance;
              controls.update();
            }
          }
          break;
        ...
        case "MOVING_TO_HOME":
          ...
          if (
            ...
            invisibleTargetRef.distanceTo(new Vector3(0, 0, 0)) <
              cameraPositionEpsilon
          ) {
            camera.position.copy(homePosition);
          ...
          if (selectedPlanet) {
            ...
            if (currentPlanetPosition) {
              ...
              const targetCameraPosition = planetPosition
                .clone()
                .add(
                  new Vector3(1, 0, 0).multiplyScalar(selectedPlanet.radius * 3)
                );
              ...
              const reachedTargetPosition =
                ...
                selectedPlanet.radius * cameraPositionEpsilon;
              const reachedTargetLookAt =
                invisibleTargetRef.distanceTo(planetPosition) <
                selectedPlanet.radius * cameraPositionEpsilon;
